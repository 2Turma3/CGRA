...
function MyClosedCilinder(scene, slices, stacks,  minS, maxS, minT, maxT, topAppearance, sideAppearance) {
    ...
    this.topAppearance = typeof topAppearance !== 'undefined' ? topAppearance : new CGFappearance(this.scene);
    this.sideAppearance = typeof sideAppearance !== 'undefined' ? sideAppearance : new CGFappearance(this.scene); 
};
